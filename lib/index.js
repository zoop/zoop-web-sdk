...
(function () {
    var options = {
        ...
        digilockerV1URL: "https://gateway.zoop.one",
    ...
    zoop.initDigilockerGateway = function initBsaGateway(request_id) {
        zoop.digilockerGatewayOption.request_id = request_id;
    };

    zoop.openDigilockerGateway = function openBsaGateway() {
        const url = `${zoop.digilockerGatewayOption.gatewayURL}/digilocker/v1/start/${zoop.digilockerGatewayOption.request_id}`;
        if (zoop.options.zoopWindow == null || zoop.options.zoopWindow.closed) {
